...
std::string GetParentDirectoryName(std::string path)
{
    ...
    std::string parentDirectoryComponent = pathComponents->Get((int)pathComponents->Count() - 2); // -2 to skip adjusted from 1-based and to skip the last element (the file itself)
